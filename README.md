...
```bash
sam-step-function-app$ sam build
```
...
```bash
sam-step-function-app$ sam logs -n StockCheckerFunction --stack-name sam-step-function-app --tail
```
...
```bash
sam-step-function-app$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name sam-step-function-app
```
